...
//           `https://api.spoonacular.com/recipes/findByIngredients?ingredients=${ingredients.join(',')}&number=6&apiKey=YOUR_API_KEY`
//         );
...
//               <button className="show-btn" onClick={() => navigate(`/recipes/${recipe.id}`)}>
//                 SHOW
//               </button>
//             </div>
//           ))}
